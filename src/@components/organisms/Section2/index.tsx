      ...
      <Bg>
        <InnerContainer>
          <Flex direction="column" align="flex-start" justify="flex-start">
            ...
            <Flex direction="row" gap={189.13}>
              <Flex align="flex-start">
                <Text text="직원들이" color={palette.Gray700} weight={400} size={22.5} height={160} />
                <Text text="만족할 만한 복지가" color={palette.Gray700} weight={400} size={22.5} height={160} />
                <Text text="무엇인지 모르겠어요" color={palette.Gray700} weight={400} size={22.5} height={160} />
              </Flex>
              <Flex align="flex-start">
                <Text text="직원들이" color={palette.Gray700} weight={400} size={22.5} height={160} />
                <Text text="만족할 만한 복지가" color={palette.Gray700} weight={400} size={22.5} height={160} />
